...
public interface AnmIM {
    Object[] BUILTIN_CONSTANTS = {
        "UV_NONE", new AnmValue(Anm.ANM_UV_NONE), "UV_REPEAT", new AnmValue(Anm.ANM_UV_REPEAT), "UV_MIRROR", new AnmValue(Anm.ANM_UV_MIRROR),
        "ORIGIN_PARENT", new AnmValue(Anm.ANM_ORIGIN_PARENT), "ORIGIN_SURFACE", new AnmValue(Anm.ANM_ORIGIN_SURFACE),
        "ANCHOR_TOP_LEFT", new AnmValue(Anm.ANM_ANCHOR_TOP_LEFT), "ANCHOR_TOP_MIDDLE", new AnmValue(Anm.ANM_ANCHOR_TOP_MIDDLE), "ANCHOR_TOP_RIGHT", new AnmValue(Anm.ANM_ANCHOR_TOP_RIGHT),
        "ANCHOR_MIDDLE_LEFT", new AnmValue(Anm.ANM_ANCHOR_MIDDLE_LEFT), "ANCHOR_CENTER", new AnmValue(Anm.ANM_ANCHOR_CENTER), "ANCHOR_MIDDLE_RIGHT", new AnmValue(Anm.ANM_ANCHOR_MIDDLE_RIGHT),
        "ANCHOR_BOTTOM_LEFT", new AnmValue(Anm.ANM_ANCHOR_BOTTOM_LEFT), "ANCHOR_BOTTOM_MIDDLE", new AnmValue(Anm.ANM_ANCHOR_BOTTOM_MIDDLE), "ANCHOR_BOTTOM_RIGHT", new AnmValue(Anm.ANM_ANCHOR_BOTTOM_RIGHT),
